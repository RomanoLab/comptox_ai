      ...
      <Container>
        ...
        >
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                {...params}
                label="Filter chemicals by EPA Chemical List (optional)"
                variant="outlined"
              />
            )}
          />
        ...
        >
          <Autocomplete
            ...
            isOptionEqualToValue={(option, value) =>
              option.assayId === value.assayId
            }
            renderInput={(params) => (
              <TextField
                {...params}
                label="QSAR assay endpoint"
                variant="outlined"
              />
            )}
          />
        ...
        <Button
          ...
          color="primary"
          type="submit"
          style={{ marginRight: 6, paddingTop: 9 }}
        >
          Build QSAR Dataset
        </Button>
...
const DatasetBuilder = (props) => {
  ...
  return (
    <div className="datasetBuilder subject-container">
      <div className="datasetBuilderHeader">
        <h2>Build QSAR Dataset</h2>
        <p>
          <i>
            Build a new dataset to use in Quantitative Structure-Activity
      ...
      <div className="datasetBuilderQuery ">
        <div className="formWrapper">
          <DatasetBuilderQueryForm config={config} chemLists={chemLists} />
        </div>
      </div>
    </div>
  );
